	...
	<div>
		...
		<table id="regTable">
			...
			<tr style="border-top: 1px solid #BDBDBD;">
				<th>아이디</th>
				<td>
					<input type="text" class="form-control" name="u_id" value="${ub.u_id }" placeholder="영문 소문자+숫자, 4~16자" pattern="^[A-Za-z0-9]{4,16}$" maxlength="16" required> 
				</td>
			</tr>
			<tr style="border-top: 1px solid #BDBDBD;">
				<th>비밀번호</th>
				<td>
					<input type="password" class="form-control" name="u_password" value="${ub.u_password }" placeholder="영문 대소문자/숫자/특수문자 중 3가지 이상 조합, 8자~16자" maxlength="16" required>
				</td>
			</tr>
			<tr style="border-top: 1px solid #BDBDBD;">
				<th>비밀번호 확인</th>
				<td>
					<input type="password" class="form-control" name="u_rePassword" maxlength="16" required>
				</td>
			</tr>
			<tr style="border-top: 1px solid #BDBDBD;">
				<th>전화번호</th>
			...
			<tr style="border-top: 1px solid #BDBDBD;">
				<th>이메일</th>
				<td>
					<input type="text" class="form-control" name="u_email" style="width: 30%; display: inline-block;" value="${fn:split(ub.u_email, '@')[0]}" required>
					@
					<input type="text" class="form-control" id="domainArea" name="u_email" style="width: 30%; display: inline-block;" value="${fn:split(ub.u_email, '@')[1]}" required>
