...
>>>>>>> 293c5d314dc421913e852911702e7bacce7b24ab
					...
					<!--영양 정보를 좌우로 반반 나눠주었으며, 왼쪽에 해당하는 div 태그-->
						<ul>
							...
							<li>
								...
								<span class="r">
									<input type="number" class="form-control" name="oqty" value="1" id="num" min="1" style="width: 60px;" placeholder="단위(개)" oninput="updateOrderAmount()">
								</span>
							</li>
						</ul>
					</div>
				...
				<button id="btn" onclick="return goCart('${pb.p_num}')"><img src="resources/image/cartAdd.svg" style="width: 20px;">&nbsp;장바구니</button>
				<button id="btn" onclick="return goOrder('${pb.p_num}')"><img src="resources/image/goOrder.svg" style="width: 20px;">&nbsp;주문하기</button>
			</div>
		</div>
	</section>
</form>
