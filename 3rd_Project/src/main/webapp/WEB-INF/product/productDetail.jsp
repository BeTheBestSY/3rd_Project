...
<div class="write-review-box">
	<form action="">
		<input type="hidden" >
		<input class="write-review-button" type="submit" value="리뷰 작성" >
	</form>
                <br>
    </div>
    <!-- 리뷰가 동적으로 여기에 추가될 것입니다. -->
    <div class="review">
        <div class="user-info">사용자1</div>
        <div class="rating">평점: 4.5</div>
        <div class="review-date">작성일: 2023-01-10</div>
        <div class="review-text">좋은 상품입니다. 다음에 또 구매하고 싶어요.</div>
         <form action="">
		    <div class="comment-box">
		        <input  type = "text" class="comment-textarea" placeholder="댓글을 작성하세요"></textarea>
		        <input type="submit" class="submit-button" value="댓글 작성">
		    </div>
	    </form>
        
        <!-- 댓글이 있다면 여기에 추가 -->
        <div class="comment">댓글: 댓글 내용1</div>
        <div class="comment">댓글: 댓글 내용2</div>
    </div>
    <div class="review">
        <div class="user-info">사용자2</div>
        <div class="rating">평점: 5</div>
        <div class="review-date">작성일: 2023-01-15</div>
        <div class="review-text">완벽한 상품이에요! 강력 추천합니다.</div>
    ...
    <form action="">
        ...
        <div class="comment">댓글: 댓글 내용3</div>
    </div>
    <!-- 추가적인 리뷰들을 여기에 계속 추가할 수 있습니다. -->
