	...
	<div id="center" style="text-align: center;">
			...
			<table class="board-table">
				<tr style="border-top: 2px solid graytext; padding:10px;">
					...
					<td width="80%">
						<input type="text" class="form-control"  style="width:70%;" name="cmp_name" value="${bb.cmp_name }" >
					</td>
				</tr>
				...
				<tr style="border-top: 1px solid #BDBDBD; padding:10px;">
					...
					<td width="80%">
						<input type="text" class="form-control" name="cmp_price" style="width:20%;" value="${bb.cmp_price }" > 원
					</td>
				</tr>
				<tr style="border-top: 1px solid #BDBDBD; padding:10px;">
				...
				<tr style="border-top: 1px solid #BDBDBD; padding:10px;">
					...
					<td width="80%">
						<input type="text" class="form-control" name="cmp_x"  class="form-control"  value="${bb.cmp_x}" >
					</td>
				</tr>
				<tr style="border-top: 1px solid #BDBDBD; padding:10px;">
					<th width="20%"><font color="red">*</font>위도</th>
					<td width="80%">
						<input type="text" class="form-control" name="cmp_y"  class="form-control"  value="${bb.cmp_y}" >
					</td>
				</tr>
				<tr>
