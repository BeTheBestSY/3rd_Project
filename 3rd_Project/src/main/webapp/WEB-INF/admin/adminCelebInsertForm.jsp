...
<article id="center" style=" text-align:center; font-family: 'MaruBuri-Regular';" >
	...
	<div id="center" style="text-align: center;">
			<form action="celebInsert.admin" method="post"  enctype="multipart/form-data" onSubmit="return checkImg()">
			<table class="board-table">
				<tr style="border-top: 1px solid #BDBDBD; padding:10px;">
					<th width="20%"><font color="red">*</font> 이름</th>
					<td width="80%">
						<input type="text" class="form-control" name="cl_name" style="width:20%;" value=" " required>
					</td>
				</tr>
				<tr style="border-top: 1px solid #BDBDBD; padding:10px;">
