...
<br><br><br>
	...
	<div id="board-list">	
		...
		<input type=hidden name="q_password" value="${ q_password }">
		...
		<input type="hidden" name="keyword" value="${keyword}">
			<table border=1>
				...
				<tr rowspan=2>
					<td align=center style="border-top: 1px solid #e7e7e7; border-bottom: 1px solid #e7e7e7; padding:5% 5%;">
						<input type="password" name="q_password" class="form-control" maxlength="12" size="12" style="text-align: center;">
					</td>
				</tr>
			...
			<center>
				...
				<input type="button" id="btn" value="목록으로" onClick="location.href='qBoardList.qb?pageNumber=${pageNumber}&whatColumn=${whatColumn}&keyword=${keyword}'" class="btn btn-dark" style="margin-top:3%; font-size: 13pt; width: 130px;">
			</center>		
		</form>
	</div>
</article>
