				...
				<div class="col-md-5 col-lg-4 order-md-last">
					...
					<ul class="list-group mb-3">
						<c:forEach var="pb" items="${ productList }" varStatus="loop">
							...
							<li class="list-group-item d-flex justify-content-between lh-sm" style="border-bottom: 1px solid #A6A6A6;">
								<span>상품 금액</span>
								<strong> 
...
>>>>>>> branch 'Lee' of https://github.com/BeTheBestSY/3rd_Project.git
						...
						<li class="list-group-item d-flex justify-content-between lh-sm">
							<span>배송비</span>
							<strong> 
							<c:if test="${totalAmount<30000}"> 3,000원 </c:if> 
							<c:if test="${totalAmount>=30000}"> 0원 </c:if>
						</strong>
						</li>
