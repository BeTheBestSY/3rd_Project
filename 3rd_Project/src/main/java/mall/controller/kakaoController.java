	...
	public String kakaopay(
		...
		KakaoApproveResponse kar = (KakaoApproveResponse)session.getAttribute("kao");
			...
			MultiValueMap<String, String> parameters = new LinkedMultiValueMap<String, String>();
		        ...
		        parameters.add("approval_url", "http://localhost:8080/ex/pay/success.mall"); // 결제승인시 넘어갈 url
		        parameters.add("cancel_url", "http://localhost:8080/ex/pay/cancel.mall"); // 결제취소시 넘어갈 url
			    parameters.add("fail_url", "http://localhost:8080/ex/pay/fail.mall"); // 결제 실패시 넘어갈 url
		        // 파라미터, 헤더
