...
<div align="center"><b>"당신의 숨겨진 아름다움을 찾아서"</b></div>
...
- 비밀번호 찾기를 진행 할 경우, 회원의 이메일이 요구되며 해당 이메일 주소에 임시비밀번호가 발급됩니다.
...
- 제목, 이메일, 내용 란을 기입해야하며 후기글 수정 및 삭제를 위해 비밀번호를 기입해야합니다.
- 작성자의 프로필사진을 클릭하면 해당 사용자의 자기소개, 작성글/답글 목록을 조회할 수 있습니다.
- (~를) 어지럽히는 사용자의 경우 신고할 수 있으며, 신고가 5회 이상 누적될 경우 정지회원으로써 (?)간 사용 정지됩니다.
